...
public class WorkMgrServiceV2 {
  ...
  @GET
  @Path("/containers")
  public Response getContainers(@Nullable @HeaderParam(CoordConsts.SVC_KEY_API_KEY) String apiKey) {
  ...
  public Response redirectContainer(
      @Nullable @HeaderParam(CoordConsts.SVC_KEY_API_KEY) String apiKey) {
