...
public class Testrig {
  ...
  private @Nullable List<Object> _configs;
  private @Nullable List<Object> _environments;
  ...
  public static Testrig of(
      ...
      @Nullable @JsonProperty(PROP_CONFIGS) List<Object> configs,
      @Nullable @JsonProperty(PROP_ENV) List<Object> environments,
  ...
  private Testrig(
      String name,
      @Nullable List<Object> configs,
      @Nullable List<Object> environments,
  ...
  @JsonProperty(PROP_ENV)
  public void setEnvironment(List<Object> environments) {
